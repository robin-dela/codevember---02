...
const GlitchPass = require('@superguigui/wagner/src/passes/glitch/GlitchPass');
...
export default class WebGL {
  constructor(params) {
    ...
    this.renderer.setClearColor(0x2F3C4F, 0);
  ...
  render() {
    ...
    this.camera.position.x += ( this.mouse.x - this.camera.position.x );
    this.camera.position.y += ( -this.mouse.y - this.camera.position.y );
